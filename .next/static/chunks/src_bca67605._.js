...
const randomContexts = [
    ...
    "pani cheyyan madi aavunnu",
    "urangaൻ samayamayi, but I need to finish this",
...
function ScheduledDistractions() {
    ...
    const startCountdown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ScheduledDistractions.useCallback[startCountdown]": ()=>{
            if (intervalRef.current) clearInterval(intervalRef.current);
            if (countdownRef.current) cancelAnimationFrame(countdownRef.current);
            setTimeLeft(intervalSeconds);
            setProgress(100);
            const animate = {
                "ScheduledDistractions.useCallback[startCountdown].animate": (startTime)=>{
                    const elapsedTime = (Date.now() - startTime) / 1000;
                    const newTimeLeft = Math.max(0, intervalSeconds - elapsedTime);
                    setTimeLeft(newTimeLeft);
                    setProgress(newTimeLeft / intervalSeconds * 100);
                    if (newTimeLeft > 0) {
                        countdownRef.current = requestAnimationFrame({
                            "ScheduledDistractions.useCallback[startCountdown].animate": ()=>animate(startTime)
                        }["ScheduledDistractions.useCallback[startCountdown].animate"]);
                    }
                }
            }["ScheduledDistractions.useCallback[startCountdown].animate"];
            const startCycle = {
                "ScheduledDistractions.useCallback[startCountdown].startCycle": ()=>{
                    const startTime = Date.now();
                    animate(startTime);
                }
            }["ScheduledDistractions.useCallback[startCountdown].startCycle"];
            startCycle(); // initial run
            intervalRef.current = setInterval(startCycle, intervalSeconds * 1000);
        }
    }["ScheduledDistractions.useCallback[startCountdown]"], [
        intervalSeconds
    ]);
    ...
    const handleSetReminder = ()=>{
        if (permission !== 'granted') {
            ...
            handleToggle(true); // Trigger permission request
            return;
        }
        if (!reminderTime) {
            toast({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            isEnabled ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(ScheduledDistractions, "TgEecw3M+rAeDmgmPnQhIsWvVbw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
//# sourceMappingURL=src_bca67605._.js.map