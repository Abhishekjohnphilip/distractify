            ...
            if (isEnabled && permission === 'granted') {
                ...
                timerRef.current = setInterval({
                    "ScheduledDistractions.useEffect": ()=>{
                        ...
                        const newProgress = Math.min(elapsedTime / (intervalSeconds * 1000) * 100, 100);
                        setProgress(newProgress);
                        if (newProgress >= 100) {
                            if (timerRef.current) clearInterval(timerRef.current);
                        }
                    }
                }["ScheduledDistractions.useEffect"], 1000);
            } else {
                sendMessageToSw({
                    type: 'stop-recurring'
                });
            ...
            isEnabled ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-sm text-muted-foreground",
                        children: [
                            "You'll get a tempting notification every ",
                            getFrequencyLabel(),
                            ". Good luck focusing!"
                        ]
                    }, void 0, true, {
...
_s(ScheduledDistractions, "yX2oY49sBRcrZ4qIJsRcJPWvGvw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
//# sourceMappingURL=src_2c1e7c44._.js.map